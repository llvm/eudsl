...
3. [mlir-python-bindings](./projects/mlir-python-bindings): Scripts/CMake for nightly builds of the upstream MLIR Python bindings;
   * Available via `pip install mlir-python-bindings -f https://llvm.github.io/eudsl`.
4. [eudsl-python-extras](./projects/eudsl-python-extras): Extra utilities for the upstream MLIR Python bindings;
...
5. [mlir-python-mcp](./projects/mlir-python-mcp): An [MCP](https://modelcontextprotocol.io) server exposing a persistent MLIR Python REPL, so that a coding agent can build and transform IR through the bindings rather than by editing MLIR text;
...
6. [eudsl-llvmpy](./projects/eudsl-llvmpy): Python bindings for LLVM IR (and Machine IR), plus small DSLs for authoring both from Python;
