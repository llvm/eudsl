...
class Pipeline(Pipeline):
    def acc_implicit_data(self, enable_implicit_reduction_copy: bool = None):
        ...
        """
        self.add_pass("acc-implicit-data", enable_implicit_reduction_copy=enable_implicit_reduction_copy)
        return self
    ...
    def acc_implicit_routine(self, device_type: 'mlir::acc::DeviceType' = None):
        ...
        """
        self.add_pass("acc-implicit-routine", device_type=device_type)
        return self

    def affine_data_copy_generate(self, fast_mem_capacity: int = None, fast_mem_space: int = None, generate_dma: bool = None, min_dma_transfer: int = None, slow_mem_space: int = None, skip_non_unit_stride_loops: bool = None, tag_mem_space: int = None):
        ...
        """
        self.add_pass("affine-data-copy-generate", fast_mem_capacity=fast_mem_capacity, fast_mem_space=fast_mem_space, generate_dma=generate_dma, min_dma_transfer=min_dma_transfer, slow_mem_space=slow_mem_space, skip_non_unit_stride_loops=skip_non_unit_stride_loops, tag_mem_space=tag_mem_space)
        return self
    ...
    def affine_loop_fusion(self, compute_tolerance: float = None, fast_mem_space: int = None, local_buf_threshold: int = None, maximal: bool = None, mode: "FusionMode" = None):
        ...
        """
        self.add_pass("affine-loop-fusion", compute_tolerance=compute_tolerance, fast_mem_space=fast_mem_space, local_buf_threshold=local_buf_threshold, maximal=maximal, mode=mode)
        return self
    ...
    def affine_loop_tile(self, cache_size: int = None, separate: bool = None, tile_size: int = None, tile_sizes: List[int] = None):
        ...
        """
        self.add_pass("affine-loop-tile", cache_size=cache_size, separate=separate, tile_size=tile_size, tile_sizes=tile_sizes)
        return self

    def affine_loop_unroll(self, unroll_factor: int = None, unroll_up_to_factor: bool = None, unroll_num_reps: int = None, unroll_full_threshold: int = None, cleanup_unroll: bool = None):
        """Unroll affine loops
        Args:
        ...
        """
        self.add_pass("affine-loop-unroll", unroll_factor=unroll_factor, unroll_up_to_factor=unroll_up_to_factor, unroll_num_reps=unroll_num_reps, unroll_full_threshold=unroll_full_threshold, cleanup_unroll=cleanup_unroll)
        return self
    ...
    def affine_parallelize(self, max_nested: int = None, parallel_reductions: bool = None):
        ...
        """
        self.add_pass("affine-parallelize", max_nested=max_nested, parallel_reductions=parallel_reductions)
        return self
    ...
    def affine_super_vectorize(self, virtual_vector_size: List[int] = None, test_fastest_varying: List[int] = None, vectorize_reductions: bool = None):
        ...
        """
        self.add_pass("affine-super-vectorize", virtual_vector_size=virtual_vector_size, test_fastest_varying=test_fastest_varying, vectorize_reductions=vectorize_reductions)
        return self
    ...
    def arith_emulate_unsupported_floats(self, source_types: List[str] = None, target_type: str = None):
        ...
        """
        self.add_pass("arith-emulate-unsupported-floats", source_types=source_types, target_type=target_type)
        return self
    ...
    def arith_emulate_wide_int(self, widest_int_supported: int = None):
        ...
        """
        self.add_pass("arith-emulate-wide-int", widest_int_supported=widest_int_supported)
        return self

    def arith_expand(self, include_bf16: bool = None, include_f8e8m0: bool = None, include_f4e2m1: bool = None):
        ...
        """
        self.add_pass("arith-expand", include_bf16=include_bf16, include_f8e8m0=include_f8e8m0, include_f4e2m1=include_f4e2m1)
        return self
    ...
    def arith_int_range_narrowing(self, int_bitwidths_supported: List[int] = None):
        ...
        """
        self.add_pass("arith-int-range-narrowing", int_bitwidths_supported=int_bitwidths_supported)
        return self
    ...
    def async_parallel_for(self, async_dispatch: bool = None, num_workers: int = None, min_task_size: int = None):
        ...
        """
        self.add_pass("async-parallel-for", async_dispatch=async_dispatch, num_workers=num_workers, min_task_size=min_task_size)
        return self
    ...
    def buffer_results_to_out_params(self, add_result_attr: bool = None, hoist_static_allocs: bool = None, hoist_dynamic_allocs: bool = None, modify_public_functions: bool = None):
        ...
        """
        self.add_pass("buffer-results-to-out-params", add_result_attr=add_result_attr, hoist_static_allocs=hoist_static_allocs, hoist_dynamic_allocs=hoist_dynamic_allocs, modify_public_functions=modify_public_functions)
        return self
    ...
    def canonicalize(self, top_down: bool = None, region_simplify: GreedySimplifyRegionLevel = None, max_iterations: int = None, max_num_rewrites: int = None, test_convergence: bool = None, disable_patterns: List[str] = None, enable_patterns: List[str] = None):
        ...
        """
        self.add_pass("canonicalize", top_down=top_down, region_simplify=region_simplify, max_iterations=max_iterations, max_num_rewrites=max_num_rewrites, test_convergence=test_convergence, disable_patterns=disable_patterns, enable_patterns=enable_patterns)
        return self

    def composite_fixed_point_pass(self, name: str = None, pipeline: str = None, max_iterations: int = None):
        ...
        """
        self.add_pass("composite-fixed-point-pass", name=name, pipeline=pipeline, max_iterations=max_iterations)
        return self
    ...
    def convert_affine_for_to_gpu(self, gpu_block_dims: int = None, gpu_thread_dims: int = None):
        ...
        """
        self.add_pass("convert-affine-for-to-gpu", gpu_block_dims=gpu_block_dims, gpu_thread_dims=gpu_thread_dims)
        return self
    ...
    def convert_arith_to_amdgpu(self, chipset: str = None, saturate_fp8_truncf: bool = None, allow_packed_f16_round_to_zero: bool = None):
        ...
        """
        self.add_pass("convert-arith-to-amdgpu", chipset=chipset, saturate_fp8_truncf=saturate_fp8_truncf, allow_packed_f16_round_to_zero=allow_packed_f16_round_to_zero)
        return self
    ...
    def convert_arith_to_spirv(self, emulate_lt_32_bit_scalar_types: bool = None, emulate_unsupported_float_types: bool = None):
        ...
        """
        self.add_pass("convert-arith-to-spirv", emulate_lt_32_bit_scalar_types=emulate_lt_32_bit_scalar_types, emulate_unsupported_float_types=emulate_unsupported_float_types)
        return self
    ...
    def convert_arm_sme_to_llvm(self, dump_tile_live_ranges: bool = None):
        ...
        """
        self.add_pass("convert-arm-sme-to-llvm", dump_tile_live_ranges=dump_tile_live_ranges)
        return self
    ...
    def convert_cf_to_spirv(self, emulate_lt_32_bit_scalar_types: bool = None, emulate_unsupported_float_types: bool = None):
        """Convert ControlFlow dialect to SPIR-V dialect
        Args:
            emulate_lt_32_bit_scalar_types: Emulate narrower scalar types with 32-bit ones if not supported by the target
            emulate_unsupported_float_types: Emulate unsupported float types by representing them with integer types of same bit width
        """
        self.add_pass("convert-cf-to-spirv", emulate_lt_32_bit_scalar_types=emulate_lt_32_bit_scalar_types, emulate_unsupported_float_types=emulate_unsupported_float_types)
        return self
    ...
    def convert_complex_to_llvm(self, complex_range: '::mlir::complex::ComplexRangeFlags' = None):
    ...
    def convert_complex_to_standard(self, complex_range: '::mlir::complex::ComplexRangeFlags' = None):
    ...
    def convert_func_to_llvm(self, use_bare_ptr_memref_call_conv: bool = None, index_bitwidth: int = None):
        ...
        Args:
            ...
            index_bitwidth: Bitwidth of the index type, 0 to use size of machine word
        """
        self.add_pass("convert-func-to-llvm", use_bare_ptr_memref_call_conv=use_bare_ptr_memref_call_conv, index_bitwidth=index_bitwidth)
        return self

    def convert_func_to_spirv(self, emulate_lt_32_bit_scalar_types: bool = None, emulate_unsupported_float_types: bool = None):
        """Convert Func dialect to SPIR-V dialect
        Args:
            emulate_lt_32_bit_scalar_types: Emulate narrower scalar types with 32-bit ones if not supported by the target
            emulate_unsupported_float_types: Emulate unsupported float types by representing them with integer types of same bit width
        """
        self.add_pass("convert-func-to-spirv", emulate_lt_32_bit_scalar_types=emulate_lt_32_bit_scalar_types, emulate_unsupported_float_types=emulate_unsupported_float_types)
        return self
    ...
    def convert_gpu_to_nvvm(self, index_bitwidth: int = None, has_redux: bool = None, use_bare_ptr_memref_call_conv: bool = None, allowed_dialects: List[str] = None):
        ...
        """
        self.add_pass("convert-gpu-to-nvvm", index_bitwidth=index_bitwidth, has_redux=has_redux, use_bare_ptr_memref_call_conv=use_bare_ptr_memref_call_conv, allowed_dialects=allowed_dialects)
        return self

    def convert_gpu_to_rocdl(self, chipset: str = None, index_bitwidth: int = None, use_bare_ptr_memref_call_conv: bool = None, runtime: "gpu::amd::Runtime" = None, allowed_dialects: List[str] = None):
        ...
        Args:
            ...
            allowed_dialects: Run conversion patterns of only the specified dialects
        """
        self.add_pass("convert-gpu-to-rocdl", chipset=chipset, index_bitwidth=index_bitwidth, use_bare_ptr_memref_call_conv=use_bare_ptr_memref_call_conv, runtime=runtime, allowed_dialects=allowed_dialects)
        return self
    ...
    def convert_math_to_emitc(self, language_target: '::mlir::emitc::LanguageTarget' = None):
    ...
    def convert_math_to_funcs(self, min_width_of_fpowi_exponent: int = None, convert_ctlz: bool = None):
        ...
        """
        self.add_pass("convert-math-to-funcs", min_width_of_fpowi_exponent=min_width_of_fpowi_exponent, convert_ctlz=convert_ctlz)
        return self
    ...
    def convert_math_to_xevm(self, convert_arith: bool = None):
        ...
        """
        self.add_pass("convert-math-to-xevm", convert_arith=convert_arith)
        return self
    ...
    def convert_memref_to_emitc(self, lower_to_cpp: bool = None):
        ...
        """
        self.add_pass("convert-memref-to-emitc", lower_to_cpp=lower_to_cpp)
        return self

    def convert_memref_to_spirv(self, bool_num_bits: int = None, use_64bit_index: bool = None):
        """Convert MemRef dialect to SPIR-V dialect
        Args:
            bool_num_bits: The number of bits to store a boolean value
            use_64bit_index: Use 64-bit integers to convert index types
        """
        self.add_pass("convert-memref-to-spirv", bool_num_bits=bool_num_bits, use_64bit_index=use_64bit_index)
        return self
    ...
    def convert_tensor_to_spirv(self, emulate_lt_32_bit_scalar_types: bool = None, emulate_unsupported_float_types: bool = None):
        """Convert Tensor dialect to SPIR-V dialect
        Args:
            emulate_lt_32_bit_scalar_types: Emulate narrower scalar types with 32-bit ones if not supported by the target
            emulate_unsupported_float_types: Emulate unsupported float types by representing them with integer types of same bit width
        """
        self.add_pass("convert-tensor-to-spirv", emulate_lt_32_bit_scalar_types=emulate_lt_32_bit_scalar_types, emulate_unsupported_float_types=emulate_unsupported_float_types)
        return self
    ...
    def convert_to_emitc(self, filter_dialects: List[str] = None):
        ...
        """
        self.add_pass("convert-to-emitc", filter_dialects=filter_dialects)
        return self

    def convert_to_llvm(self, filter_dialects: List[str] = None, dynamic: bool = None, allow_pattern_rollback: bool = None):
        ...
        """
        self.add_pass("convert-to-llvm", filter_dialects=filter_dialects, dynamic=dynamic, allow_pattern_rollback=allow_pattern_rollback)
        return self
    ...
    def convert_vector_to_llvm(self, reassociate_fp_reductions: bool = None, force_32bit_vector_indices: bool = None, use_vector_alignment: bool = None, enable_amx: bool = None, enable_arm_neon: bool = None, enable_arm_sve: bool = None, enable_arm_i8mm: bool = None, enable_arm_bf16: bool = None, enable_x86vector: bool = None, vector_contract_lowering: 'vector::VectorContractLowering' = None, vector_transpose_lowering: 'vector::VectorTransposeLowering' = None):
        ...
        """
        self.add_pass("convert-vector-to-llvm", reassociate_fp_reductions=reassociate_fp_reductions, force_32bit_vector_indices=force_32bit_vector_indices, use_vector_alignment=use_vector_alignment, enable_amx=enable_amx, enable_arm_neon=enable_arm_neon, enable_arm_sve=enable_arm_sve, enable_arm_i8mm=enable_arm_i8mm, enable_arm_bf16=enable_arm_bf16, enable_x86vector=enable_x86vector, vector_contract_lowering=vector_contract_lowering, vector_transpose_lowering=vector_transpose_lowering)
        return self

    def convert_vector_to_scf(self, full_unroll: bool = None, target_rank: int = None, lower_tensors: bool = None, lower_scalable: bool = None):
        ...
        """
        self.add_pass("convert-vector-to-scf", full_unroll=full_unroll, target_rank=target_rank, lower_tensors=lower_tensors, lower_scalable=lower_scalable)
        return self
    ...
    def enable_arm_streaming(self, streaming_mode: 'mlir::arm_sme::ArmStreamingMode' = None, za_mode: 'mlir::arm_sme::ArmZaMode' = None, if_required_by_ops: bool = None, if_scalable_and_supported: bool = None):
        ...
        """
        self.add_pass("enable-arm-streaming", streaming_mode=streaming_mode, za_mode=za_mode, if_required_by_ops=if_required_by_ops, if_scalable_and_supported=if_scalable_and_supported)
        return self

    def ensure_debug_info_scope_on_llvm_func(self, emission_kind: 'mlir::LLVM::DIEmissionKind' = None):
        ...
        """
        self.add_pass("ensure-debug-info-scope-on-llvm-func", emission_kind=emission_kind)
        return self
    ...
    def finalize_memref_to_llvm(self, use_aligned_alloc: bool = None, index_bitwidth: int = None, use_generic_functions: bool = None):
        ...
        """
        self.add_pass("finalize-memref-to-llvm", use_aligned_alloc=use_aligned_alloc, index_bitwidth=index_bitwidth, use_generic_functions=use_generic_functions)
        return self
    ...
    def generate_runtime_verification(self, verbose_level: int = None):
        ...
        """
        self.add_pass("generate-runtime-verification", verbose_level=verbose_level)
        return self
    ...
    def gpu_kernel_outlining(self, data_layout_str: str = None):
        ...
        """
        self.add_pass("gpu-kernel-outlining", data_layout_str=data_layout_str)
        return self
    ...
    def gpu_map_parallel_loops(self, mapping_policy: str = None):
        ...
        """
        self.add_pass("gpu-map-parallel-loops", mapping_policy=mapping_policy)
        return self

    def gpu_module_to_binary(self, toolkit: str = None, l: List[str] = None, opts: str = None, format: str = None, section: str = None):
        ...
        """
        self.add_pass("gpu-module-to-binary", toolkit=toolkit, l=l, opts=opts, format=format, section=section)
        return self

    def gpu_to_llvm(self, use_bare_pointers_for_host: bool = None, use_bare_pointers_for_kernels: bool = None, intersperse_sizes_for_kernels: bool = None):
        ...
        """
        self.add_pass("gpu-to-llvm", use_bare_pointers_for_host=use_bare_pointers_for_host, use_bare_pointers_for_kernels=use_bare_pointers_for_kernels, intersperse_sizes_for_kernels=intersperse_sizes_for_kernels)
        return self

    def inline(self, default_pipeline: str = None, op_pipelines: List["OpPassManager"] = None, max_iterations: int = None, inlining_threshold: int = None):
        ...
        """
        self.add_pass("inline", default_pipeline=default_pipeline, op_pipelines=op_pipelines, max_iterations=max_iterations, inlining_threshold=inlining_threshold)
        return self
    ...
    def linalg_block_pack_matmul(self, block_factors: List[int] = None, allow_padding: bool = None, mnk_padded_multiples: List[int] = None, mnk_order: List[int] = None, lhs_transpose_outer_blocks: bool = None, lhs_transpose_inner_blocks: bool = None, rhs_transpose_outer_blocks: bool = None, rhs_transpose_inner_blocks: bool = None):
        ...
        """
        self.add_pass("linalg-block-pack-matmul", block_factors=block_factors, allow_padding=allow_padding, mnk_padded_multiples=mnk_padded_multiples, mnk_order=mnk_order, lhs_transpose_outer_blocks=lhs_transpose_outer_blocks, lhs_transpose_inner_blocks=lhs_transpose_inner_blocks, rhs_transpose_outer_blocks=rhs_transpose_outer_blocks, rhs_transpose_inner_blocks=rhs_transpose_inner_blocks)
        return self
    ...
    def linalg_fold_unit_extent_dims(self, use_rank_reducing_slices: bool = None):
        ...
        """
        self.add_pass("linalg-fold-unit-extent-dims", use_rank_reducing_slices=use_rank_reducing_slices)
        return self
    ...
    def linalg_morph_ops(self, named_to_category: bool = None, category_to_generic: bool = None, named_to_generic: bool = None, generic_to_named: bool = None):
        ...
        """
        self.add_pass("linalg-morph-ops", named_to_category=named_to_category, category_to_generic=category_to_generic, named_to_generic=named_to_generic, generic_to_named=generic_to_named)
        return self
    ...
    def llvm_target_to_data_layout(self, initialize_llvm_targets: bool = None):
        ...
        """
        self.add_pass("llvm-target-to-data-layout", initialize_llvm_targets=initialize_llvm_targets)
        return self
    ...
    def llvm_target_to_target_features(self, initialize_llvm_targets: bool = None):
        ...
        Args:
            initialize_llvm_targets: Whether to pre-load all available target machines, that LLVM is configured to support, into the TargetRegistry.
        """
        self.add_pass("llvm-target-to-target-features", initialize_llvm_targets=initialize_llvm_targets)
        return self
    ...
    def lower_sparse_ops_to_foreach(self, enable_runtime_library: bool = None, enable_convert: bool = None):
        ...
        """
        self.add_pass("lower-sparse-ops-to-foreach", enable_runtime_library=enable_runtime_library, enable_convert=enable_convert)
        return self
    ...
    def lower_vector_multi_reduction(self, lowering_strategy: 'mlir::vector::VectorMultiReductionLowering' = None):
        """Lower 'vector.multi_reduction' operations
        Args:
            lowering_strategy: Select the strategy to control how multi_reduction is lowered.
        """
        self.add_pass("lower-vector-multi-reduction", lowering_strategy=lowering_strategy)
        return self
    ...
    def math_extend_to_supported_types(self, extra_types: List[str] = None, target_type: str = None):
        ...
        Args:
            ...
            target_type: MLIR type to convert the unsupported source types to
        """
        self.add_pass("math-extend-to-supported-types", extra_types=extra_types, target_type=target_type)
        return self
    ...
    def memref_emulate_wide_int(self, widest_int_supported: int = None):
        ...
        Args:
            widest_int_supported: Widest integer type supported by the target
        """
        self.add_pass("memref-emulate-wide-int", widest_int_supported=widest_int_supported)
        return self
    ...
    def nvvm_attach_target(self, module: str = None, triple: str = None, chip: str = None, features: str = None, O: int = None, fast: bool = None, ftz: bool = None, l: List[str] = None, ptxas_cmd_options: str = None):
        ...
        """
        self.add_pass("nvvm-attach-target", module=module, triple=triple, chip=chip, features=features, O=O, fast=fast, ftz=ftz, l=l, ptxas_cmd_options=ptxas_cmd_options)
        return self
    ...
    def one_shot_bufferize(self, allow_return_allocs_from_loops: bool = None, allow_unknown_ops: bool = None, analysis_fuzzer_seed: int = None, analysis_heuristic: str = None, bufferize_function_boundaries: bool = None, check_parallel_regions: bool = None, copy_before_write: bool = None, dialect_filter: List[str] = None, dump_alias_sets: bool = None, no_analysis_func_filter: List[str] = None, function_boundary_type_conversion: 'LayoutMapOption' = None, must_infer_memory_space: bool = None, use_encoding_for_memory_space: bool = None, test_analysis_only: bool = None, print_conflicts: bool = None, unknown_type_conversion: 'LayoutMapOption' = None, buffer_alignment: int = None):
        """One-Shot Bufferize
        ...
        * `bottom-up-from-terminators`: Traverse the reverse use-def chains of
        ...
        """
        self.add_pass("one-shot-bufferize", allow_return_allocs_from_loops=allow_return_allocs_from_loops, allow_unknown_ops=allow_unknown_ops, analysis_fuzzer_seed=analysis_fuzzer_seed, analysis_heuristic=analysis_heuristic, bufferize_function_boundaries=bufferize_function_boundaries, check_parallel_regions=check_parallel_regions, copy_before_write=copy_before_write, dialect_filter=dialect_filter, dump_alias_sets=dump_alias_sets, no_analysis_func_filter=no_analysis_func_filter, function_boundary_type_conversion=function_boundary_type_conversion, must_infer_memory_space=must_infer_memory_space, use_encoding_for_memory_space=use_encoding_for_memory_space, test_analysis_only=test_analysis_only, print_conflicts=print_conflicts, unknown_type_conversion=unknown_type_conversion, buffer_alignment=buffer_alignment)
        return self

    def openacc_legalize_data_values(self, host_to_device: bool = None, apply_to_acc_data_construct: bool = None):
        ...
        """
        self.add_pass("openacc-legalize-data-values", host_to_device=host_to_device, apply_to_acc_data_construct=apply_to_acc_data_construct)
        return self

    def opt_reduction_pass(self, opt_pass: str = None, test: str = None, test_arg: List[str] = None):
        ...
        """
        self.add_pass("opt-reduction-pass", opt_pass=opt_pass, test=test, test_arg=test_arg)
        return self
    ...
    def ownership_based_buffer_deallocation(self, private_function_dynamic_ownership: bool = None):
        ...
        * A function must not return a MemRef with the same allocated base buffer as
        ...
        """
        self.add_pass("ownership-based-buffer-deallocation", private_function_dynamic_ownership=private_function_dynamic_ownership)
        return self
    ...
    def promote_buffers_to_stack(self, max_alloc_size_in_bytes: int = None, max_rank_of_allocated_memref: int = None):
        ...
        """
        self.add_pass("promote-buffers-to-stack", max_alloc_size_in_bytes=max_alloc_size_in_bytes, max_rank_of_allocated_memref=max_rank_of_allocated_memref)
        return self
    ...
    def reduction_tree(self, traversal_mode: int = None, test: str = None, test_arg: List[str] = None):
        ...
        Args:
            ...
            test_arg: arguments of the tester
        """
        self.add_pass("reduction-tree", traversal_mode=traversal_mode, test=test, test_arg=test_arg)
        return self
    ...
    def resolve_ranked_shaped_type_result_dims(self, error_on_pattern_iteration_limit: bool = None):
        ...
        """
        self.add_pass("resolve-ranked-shaped-type-result-dims", error_on_pattern_iteration_limit=error_on_pattern_iteration_limit)
        return self

    def resolve_shaped_type_result_dims(self, error_on_pattern_iteration_limit: bool = None):
        ...
        Args:
            error_on_pattern_iteration_limit: Throw an error when pattern rewriter hits iteration limit
        """
        self.add_pass("resolve-shaped-type-result-dims", error_on_pattern_iteration_limit=error_on_pattern_iteration_limit)
        return self

    def rocdl_attach_target(self, module: str = None, triple: str = None, chip: str = None, features: str = None, abi: str = None, O: int = None, wave64: bool = None, fast: bool = None, daz: bool = None, finite_only: bool = None, unsafe_math: bool = None, correct_sqrt: bool = None, l: List[str] = None):
        ...
        Args:
            ...
            l: Extra bitcode libraries paths to link to.
        """
        self.add_pass("rocdl-attach-target", module=module, triple=triple, chip=chip, features=features, abi=abi, O=O, wave64=wave64, fast=fast, daz=daz, finite_only=finite_only, unsafe_math=unsafe_math, correct_sqrt=correct_sqrt, l=l)
        return self
    ...
    def scf_for_loop_peeling(self, peel_front: bool = None, skip_partial: bool = None):
        ...
        """
        self.add_pass("scf-for-loop-peeling", peel_front=peel_front, skip_partial=skip_partial)
        return self
    ...
    def scf_parallel_loop_tiling(self, parallel_loop_tile_sizes: List[int] = None, no_min_max_bounds: bool = None):
        """Tile parallel loops
        Args:
        ...
        """
        self.add_pass("scf-parallel-loop-tiling", parallel_loop_tile_sizes=parallel_loop_tile_sizes, no_min_max_bounds=no_min_max_bounds)
        return self
    ...
    def snapshot_op_locations(self, filename: str = None, tag: str = None, print_debuginfo: bool = None, print_op_generic: bool = None, print_local_scope: bool = None, pretty_debuginfo: bool = None):
        ...
        * If set, the new location is fused with the original location in the form
        ...
        """
        self.add_pass("snapshot-op-locations", filename=filename, tag=tag, print_debuginfo=print_debuginfo, print_op_generic=print_op_generic, print_local_scope=print_local_scope, pretty_debuginfo=pretty_debuginfo)
        return self
    ...
    def sparse_buffer_rewrite(self, enable_buffer_initialization: bool = None):
        ...
        """
        self.add_pass("sparse-buffer-rewrite", enable_buffer_initialization=enable_buffer_initialization)
        return self

    def sparse_gpu_codegen(self, num_threads: int = None, enable_runtime_library: bool = None):
        ...
        Args:
            ...
            enable_runtime_library: Enable runtime library for manipulating sparse tensors
        """
        self.add_pass("sparse-gpu-codegen", num_threads=num_threads, enable_runtime_library=enable_runtime_library)
        return self

    def sparse_reinterpret_map(self, scope: 'mlir::ReinterpretMapScope' = None, loop_ordering_strategy: 'mlir::sparse_tensor::LoopOrderingStrategy' = None):
        ...
        """
        self.add_pass("sparse-reinterpret-map", scope=scope, loop_ordering_strategy=loop_ordering_strategy)
        return self
    ...
    def sparse_tensor_codegen(self, enable_buffer_initialization: bool = None, create_sparse_deallocs: bool = None):
        ...
        """
        self.add_pass("sparse-tensor-codegen", enable_buffer_initialization=enable_buffer_initialization, create_sparse_deallocs=create_sparse_deallocs)
        return self
    ...
    def sparse_vectorization(self, vl: int = None, enable_vla_vectorization: bool = None, enable_simd_index32: bool = None):
        ...
        """
        self.add_pass("sparse-vectorization", vl=vl, enable_vla_vectorization=enable_vla_vectorization, enable_simd_index32=enable_simd_index32)
        return self

    def sparsification(self, parallelization_strategy: SparseParallelizationStrategy = None, sparse_emit_strategy: 'mlir::SparseEmitStrategy' = None, enable_runtime_library: bool = None):
        ...
        Args:
            ...
            enable_runtime_library: Enable runtime library for manipulating sparse tensors
        """
        self.add_pass("sparsification", parallelization_strategy=parallelization_strategy, sparse_emit_strategy=sparse_emit_strategy, enable_runtime_library=enable_runtime_library)
        return self

    def sparsification_and_bufferization(self, vl: int = None, enable_vla_vectorization: bool = None, enable_simd_index32: bool = None, enable_gpu_libgen: bool = None, sparse_emit_strategy: 'mlir::SparseEmitStrategy' = None, parallelization_strategy: SparseParallelizationStrategy = None):
        ...
        Args:
            ...
            parallelization_strategy: Set the parallelization strategy
        """
        self.add_pass("sparsification-and-bufferization", vl=vl, enable_vla_vectorization=enable_vla_vectorization, enable_simd_index32=enable_simd_index32, enable_gpu_libgen=enable_gpu_libgen, sparse_emit_strategy=sparse_emit_strategy, parallelization_strategy=parallelization_strategy)
        return self

    def spirv_attach_target(self, module: str = None, ver: str = None, caps: List[str] = None, exts: List[str] = None, client_api: str = None, vendor: str = None, device_type: str = None, device_id: 'uint32_t' = None):
        ...
        Args:
            ...
            device_id: Device ID
        """
        self.add_pass("spirv-attach-target", module=module, ver=ver, caps=caps, exts=exts, client_api=client_api, vendor=vendor, device_type=device_type, device_id=device_id)
        return self
    ...
    def test_arm_sme_tile_allocation(self, dump_tile_live_ranges: bool = None, preprocess_only: bool = None):
        ...
        """
        self.add_pass("test-arm-sme-tile-allocation", dump_tile_live_ranges=dump_tile_live_ranges, preprocess_only=preprocess_only)
        return self

    def test_scf_parallel_loop_collapsing(self, collapsed_indices_0: List[int] = None, collapsed_indices_1: List[int] = None, collapsed_indices_2: List[int] = None):
        ...
        """
        self.add_pass("test-scf-parallel-loop-collapsing", collapsed_indices_0=collapsed_indices_0, collapsed_indices_1=collapsed_indices_1, collapsed_indices_2=collapsed_indices_2)
        return self
    ...
    def tosa_attach_target(self, specification_version: 'mlir::tosa::SpecificationVersion' = None, level: 'mlir::tosa::Level' = None, profiles: List[str] = None, extensions: List[str] = None):
        ...
        """
        self.add_pass("tosa-attach-target", specification_version=specification_version, level=level, profiles=profiles, extensions=extensions)
        return self
    ...
    def tosa_layerwise_constant_fold(self, aggressive_reduce_constant: bool = None):
        ...
        """
        self.add_pass("tosa-layerwise-constant-fold", aggressive_reduce_constant=aggressive_reduce_constant)
        return self
    ...
    def tosa_to_arith(self, include_apply_rescale: bool = None, use_32_bit: bool = None):
        ...
        """
        self.add_pass("tosa-to-arith", include_apply_rescale=include_apply_rescale, use_32_bit=use_32_bit)
        return self

    def tosa_to_linalg(self, disable_tosa_decompositions: bool = None, aggressive_reduce_constant: bool = None):
        ...
        """
        self.add_pass("tosa-to-linalg", disable_tosa_decompositions=disable_tosa_decompositions, aggressive_reduce_constant=aggressive_reduce_constant)
        return self
    ...
    def tosa_to_linalg_named(self, prefer_conv2d_kernel_layout_hwcf: bool = None):
        ...
        """
        self.add_pass("tosa-to-linalg-named", prefer_conv2d_kernel_layout_hwcf=prefer_conv2d_kernel_layout_hwcf)
        return self
    ...
    def tosa_validate(self, strict_op_spec_alignment: bool = None, allow_invalid_op_datatype_combinations: bool = None):
        ...
        """
        self.add_pass("tosa-validate", strict_op_spec_alignment=strict_op_spec_alignment, allow_invalid_op_datatype_combinations=allow_invalid_op_datatype_combinations)
        return self
    ...
    def transform_interpreter(self, debug_payload_root_tag: str = None, debug_bind_trailing_args: List[str] = None, disable_expensive_checks: bool = None, entry_point: str = None):
        ...
        """
        self.add_pass("transform-interpreter", debug_payload_root_tag=debug_payload_root_tag, debug_bind_trailing_args=debug_bind_trailing_args, disable_expensive_checks=disable_expensive_checks, entry_point=entry_point)
        return self
    ...
    def transform_preload_library(self, transform_library_paths: List[str] = None):
        ...
        """
        self.add_pass("transform-preload-library", transform_library_paths=transform_library_paths)
        return self

    def view_op_graph(self, max_label_len: int = None, print_attrs: bool = None, print_control_flow_edges: bool = None, print_data_flow_edges: bool = None, print_result_types: bool = None):
        ...
        """
        self.add_pass("view-op-graph", max_label_len=max_label_len, print_attrs=print_attrs, print_control_flow_edges=print_control_flow_edges, print_data_flow_edges=print_data_flow_edges, print_result_types=print_result_types)
        return self
    ...
    def xegpu_propagate_layout(self, print_analysis_only: bool = None, layout_kind: str = None):
        ...
        """
        self.add_pass("xegpu-propagate-layout", print_analysis_only=print_analysis_only, layout_kind=layout_kind)
        return self
    ...
    def xevm_attach_target(self, module: str = None, triple: str = None, chip: str = None, O: int = None, l: List[str] = None, cmd_options: str = None):
        ...
        """
        self.add_pass("xevm-attach-target", module=module, triple=triple, chip=chip, O=O, l=l, cmd_options=cmd_options)
        return self
