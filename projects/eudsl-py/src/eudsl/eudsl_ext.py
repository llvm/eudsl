...
class ArrayRef[a]:
    def __init__(self, arg: SmallVector[a], /) -> None: ...
...
class ArrayRef[m]:
    def __init__(self, arg: SmallVector[m], /) -> None: ...
...
class SmallVector[a]:
    ...
    @overload
    def __getitem__(self, arg: slice, /) -> SmallVector[a]: ...
    ...
    def extend(self, arg: SmallVector[a], /) -> None:
        """Extend `self` by appending elements from `arg`."""
    ...
    @overload
    def __setitem__(self, arg0: slice, arg1: SmallVector[a], /) -> None: ...
...
class SmallVector[m]:
    ...
    @overload
    def __getitem__(self, arg: slice, /) -> SmallVector[m]: ...
    ...
    def extend(self, arg: SmallVector[m], /) -> None:
        """Extend `self` by appending elements from `arg`."""
    ...
    @overload
    def __setitem__(self, arg0: slice, arg1: SmallVector[m], /) -> None: ...
