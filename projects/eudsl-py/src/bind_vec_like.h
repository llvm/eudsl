...
nanobind::class_<llvm::ArrayRef<Element>> bind_array_ref(nanobind::handle scope,
                                                         Args &&...args) {
  ...
  smallVector.def_static(
      "__class_getitem__",
      [_smallVectorOfElement](nanobind::class_<llvm::SmallVector<Element>>) {
  ...
  arrayRef.def_static("__class_getitem__",
                      [cl](nanobind::class_<ArrayRef>) { return cl; });
