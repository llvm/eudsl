...
solution -- re-checking the live-register matrix. There is deliberately no
greedy fallback for the ILP's own decisions: a missing or matrix-infeasible
assignment is a hard error, so a model bug surfaces instead of being silently
